...
export class OrdersController {
    ...
    @ApiResponse({ status: 200, description: "Quantidade total de pedidos e quantidade de pedidos mensal atual" })
    async getOrders() {
    ...
    @ApiResponse({ status: 200, description: "Faturamento total e faturamento mensal atual" })
    async getInvoicing() {
    ...
    @ApiResponse({ status: 200, description: "Faturamento de cada mês deste ano e do ano passado" })
    ...
    @ApiResponse({ status: 200, description: "Dados de qtd de pedidos e itens, faturamento total, porcentagem perante ao total de todos os canais, ticket e tag do canal.\nTudo agrupado por canal" })
    async getByChannels() {
